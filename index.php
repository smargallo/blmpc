                                                        ...
                                                        <div class="row col-12 mx-auto">
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" name="tin" value="<?= $row['tin'] ?>" placeholder="TIN number">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="number" class="form-control" value="<?= $row['mobile_number'] ?>" name="mobile-number" placeholder="Mobile">
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="address" class="form-control form-control" name="Address" value="<?= $row['address'] ?>" placeholder="Address (Purok)">
                                                                </div>
